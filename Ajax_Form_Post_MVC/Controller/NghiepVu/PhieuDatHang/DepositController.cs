			...
			if (base.ModelState.IsValid)
			{
				...
				else
				{
					...
					if (detail.Data != null)
					{
						...
						{
							v_dm_KhachHang2.CONGNOTHONGBAO = ((!(v_dm_KhachHang2.MAX_CONGNO > 0.0)) 
								? ((v_ThongKeCongNoKhachHang2.TONGTIENCONGNOCUOIKY > 0.0) ? ("Công nợ: " + v_ThongKeCongNoKhachHang2.TONGTIENCONGNOCUOIKY.ToString("N0") + (v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI != null && (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days >= v_ThongKeCongNoKhachHang2.SONGAY ? " (" + v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.ToString("dd/MM/yyyy") +"-" + (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days +  ")" : "")) : "") : ((v_ThongKeCongNoKhachHang2.TONGTIENCONGNOCUOIKY >= v_dm_KhachHang2.MAX_CONGNO) ? ("Công nợ: " + v_ThongKeCongNoKhachHang2.TONGTIENCONGNOCUOIKY.ToString("N0") + " > " + v_dm_KhachHang2.MAX_CONGNO.ToString("N0") + (v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI != null && (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days >= v_ThongKeCongNoKhachHang2.SONGAY ? " (" +  v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.ToString("dd/MM/yyyy") +"-" + (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days + ")" : "")) : ("Công nợ: " + v_ThongKeCongNoKhachHang2.TONGTIENCONGNOCUOIKY.ToString("N0") + "(" + v_dm_KhachHang2.MAX_CONGNO.ToString("N0") + ")" + (v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI != null && (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days >= v_ThongKeCongNoKhachHang2.SONGAY ? " (" + v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.ToString("dd/MM/yyyy") + "-" + (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days + ")" : ""))));
							v_dm_KhachHang2.KHONGDUOCPHEPTAO = (v_dm_KhachHang2.MAX_CONGNO > 0.0 && v_ThongKeCongNoKhachHang2.TONGTIENCONGNOCUOIKY >= v_dm_KhachHang2.MAX_CONGNO) || (v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI != null && (DateTime.Now.Date - v_ThongKeCongNoKhachHang2.NGAY_PHIEUXUAT_CUOI.Value.Date).Days >= v_ThongKeCongNoKhachHang2.SONGAY && v_ThongKeCongNoKhachHang2.SONGAY > 0);
