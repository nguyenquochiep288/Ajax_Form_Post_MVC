    ...
    public class GroupPermissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LOC_ID,MA,NAME,NOTE,ISPHANQUYEN,ISACTIVE,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_web_NhomQuyen web_NhomQuyen)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var apiResponse = Utility.Create<v_v_web_NhomQuyen>(web_NhomQuyen, API.web_NhomQuyen);
                    if (apiResponse.Success)
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    if (apiResponse.Data != null)
                        web_NhomQuyen = apiResponse.Data as v_v_web_NhomQuyen;
                }
        ...
        public ActionResult Edit([Bind(Include = "ID,LOC_ID,MA,NAME,NOTE,ISPHANQUYEN,ISACTIVE,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_web_NhomQuyen web_NhomQuyen)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    //@ConvertObjectUnicodeToTCVN3
                    var apiResponse = Utility.Edit<v_v_web_NhomQuyen>(Utility.LOC_ID + "/" + web_NhomQuyen.MA, web_NhomQuyen, API.web_NhomQuyen);
                    if (apiResponse.Success)
                        return RedirectToAction("Index");
                    else
                        ModelState.AddModelError(string.Empty, apiResponse.Message);
        ...
        public ActionResult CreatePopup()
        {
            ...
            try
            {
                ...
                web_NhomQuyen.LOC_ID = Utility.LOC_ID;
                web_NhomQuyen.ID = Guid.NewGuid().ToString();
                apiResponse.Detail = Utility.ConvertobjectTo<v_v_web_NhomQuyen>(web_NhomQuyen);
                return new JsonResult() { Data = apiResponse, JsonRequestBehavior = JsonRequestBehavior.AllowGet, MaxJsonLength = Int32.MaxValue };
            }
            catch (Exception ex)
            {
        ...
        public ActionResult CreatePopup([Bind(Include = "ID,LOC_ID,MA,NAME,NOTE,ISPHANQUYEN,ISACTIVE,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_web_NhomQuyen web_NhomQuyen)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    apiResponse = Utility.Create<v_v_web_NhomQuyen>(web_NhomQuyen, API.web_NhomQuyen);
                    if (apiResponse.Success)
                    {
                ...
                else
                {
                    ...
                    apiResponse.Data = Utility.GetModelState(ModelState, API.web_NhomQuyen);
                }
