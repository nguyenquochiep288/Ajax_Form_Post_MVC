    ...
    public class CurrencyController : Controller
    {
        ...
        public ActionResult Index(int Page = 1, string SearchString = "", string ShowSearchValue = "")
        {
            try
            {
                ...
                if (!Utility.KiemTraQuyen(API.dm_TienTe, API.Xem))
                {
                    TempData["TitleError"] = API.TitlePermission;
                    return RedirectToAction("Index", "Notfound");
                }
                ShowSearchValue = Utility.GetShowSearchValue<dm_TienTe>(ShowSearchValue);
                var apiResponse = Utility.GetListData<v_dm_TienTe>(API.dm_TienTe, ShowSearchValue, SearchString, Utility.LOC_ID);
                if (!apiResponse.Success)
                {
                    TempData["TitleError"] = apiResponse.Message;
                    return RedirectToAction("Index", "Notfound");
                }
                IPagedList<v_dm_TienTe> lstpage = (apiResponse.Data as List<v_dm_TienTe>).ToPagedList(Page, Utility.GetPageSize());

                v_v_dm_TienTe dm_TienTe = new v_v_dm_TienTe();
                dm_TienTe.IPagedList = lstpage;
                //@LSTKHOAINGOAI

                ViewBag.searchValue = SearchString;
                ViewBag.showsearchValue = ShowSearchValue;

                ViewBag.PermissionEdit = Utility.KiemTraQuyen(API.dm_TienTe, API.Edit);
                ViewBag.PermissionDelete = Utility.KiemTraQuyen(API.dm_TienTe, API.Delete);
                ViewBag.PermissionCreate = Utility.KiemTraQuyen(API.dm_TienTe, API.Create);
        ...
        public ActionResult Create(int type = 2)
        {
            try
            {
                ...
                if (!Utility.KiemTraQuyen(API.dm_TienTe, API.Create))
                {
                    TempData["TitleError"] = API.TitlePermission;
                    return RedirectToAction("Index", "Notfound");
                }
                ...
                dm_TienTe.ID_NGUOITAO = Session[Sessions.idUser].ToString();
                dm_TienTe.THOIGIANTHEM = Utility.CurrentTime;

                dm_TienTe.ID = Guid.NewGuid().ToString();
                //@LSTKHOAINGOAI
                return View(dm_TienTe);
            }
            catch (Exception ex)
        ...
        public ActionResult Create([Bind(Include = "LOC_ID,ID,MA,NAME,RATE,ISACTIVE,ISDEFAULT,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_dm_TienTe dm_TienTe)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var apiResponse = Utility.Create<dm_TienTe>(dm_TienTe, API.dm_TienTe);
                    if (apiResponse.Success)
        ...
        public ActionResult Edit(string id, int type = 2)
        {
            ...
            try
            {
                ...
                if (!Utility.KiemTraQuyen(API.dm_TienTe, API.Edit))
                {
                    TempData["TitleError"] = API.TitlePermission;
                    return RedirectToAction("Index", "Notfound");
                }
                ...
                {
                    apiResponse = Utility.GetDetail<v_v_dm_TienTe>(Utility.LOC_ID + "/" + id, API.dm_TienTe);
                    if (!apiResponse.Success)
                    {
                        TempData["TitleError"] = apiResponse.Message;
                        return RedirectToAction("Index", "Notfound");
                    ...
                    if (apiResponse.Data != null)
                        dm_TienTe = apiResponse.Data as v_v_dm_TienTe;
                }
        ...
        public ActionResult Edit([Bind(Include = "LOC_ID,ID,MA,NAME,RATE,ISACTIVE,ISDEFAULT,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_dm_TienTe dm_TienTe)
        {
            try
            {
                ...
                {
                    dm_TienTe.LOC_ID = Utility.LOC_ID;
                    dm_TienTe.ID_NGUOISUA = Session[Sessions.idUser].ToString();
                    dm_TienTe.THOIGIANSUA = Utility.CurrentTime;
                    //@ConvertObjectUnicodeToTCVN3
                    var apiResponse = Utility.Edit<v_dm_TienTe>(Utility.LOC_ID + "/" + dm_TienTe.MA, dm_TienTe, API.dm_TienTe);
                    if (apiResponse.Success)
                        return RedirectToAction("Index");
                    else
                        ModelState.AddModelError(string.Empty, apiResponse.Message);
        ...
        public ActionResult Delete(string id)
        {
            try
            {
                ...
                if (!Utility.KiemTraQuyen(API.dm_TienTe, API.Delete))
                {
                    TempData["TitleError"] = API.TitlePermission;
                    return RedirectToAction("Index", "Notfound");
                }
                var apiResponse = Utility.Delete<v_dm_TienTe>(Utility.LOC_ID + "/" + id, API.dm_TienTe);
                if (apiResponse.Success)
                    return RedirectToAction("Index");
                else
                    ModelState.AddModelError(string.Empty, apiResponse.Message);
        ...
        public ActionResult CreatePopup()
        {
            ...
            try
            {
                ...
                dm_TienTe.LOC_ID = Utility.LOC_ID;
                dm_TienTe.ID = Guid.NewGuid().ToString();
                apiResponse.Detail = Utility.ConvertobjectTo<v_v_dm_TienTe>(dm_TienTe);
                return new JsonResult() { Data = apiResponse, JsonRequestBehavior = JsonRequestBehavior.AllowGet, MaxJsonLength = Int32.MaxValue };
            }
            catch (Exception ex)
            {
        ...
        public ActionResult CreatePopup([Bind(Include = "LOC_ID,ID,MA,NAME,RATE,ISACTIVE,ISDEFAULT,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_dm_TienTe dm_TienTe)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    apiResponse = Utility.Create<dm_TienTe>(dm_TienTe, API.dm_TienTe);
                    if (apiResponse.Success)
                    {
                ...
                else
                {
                    ...
                    apiResponse.Data = Utility.GetModelState(ModelState, API.dm_TienTe);
                }
                apiResponse.ID = dm_TienTe.ID;
                apiResponse.Detail = Utility.ConvertobjectToView<v_dm_TienTe>(dm_TienTe);
                return new JsonResult() { Data = apiResponse, JsonRequestBehavior = JsonRequestBehavior.AllowGet, MaxJsonLength = Int32.MaxValue };
            }
            catch (Exception ex)
            {
        ...
        public ActionResult EditPopup([Bind(Include = "LOC_ID,ID,MA,NAME,RATE,ISACTIVE,ISDEFAULT,THOIGIANSUA,ID_NGUOISUA,THOIGIANTHEM,ID_NGUOITAO")] v_v_dm_TienTe dm_TienTe)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    apiResponse = Utility.Edit<v_dm_TienTe>(Utility.LOC_ID + "/" + dm_TienTe.MA, dm_TienTe, API.dm_TienTe);
                    if (apiResponse.Success)
                    {
                        //return RedirectToAction("Index");
                        apiResponse.ID = dm_TienTe.ID;
        ...
        public ActionResult DeletePopup(string id)
        {
            ...
            try
            {
                ...
                apiResponse = Utility.Delete<v_dm_TienTe>(Utility.LOC_ID + "/" + id, API.dm_TienTe);
                apiResponse.ID = id;
                return new JsonResult() { Data = apiResponse, JsonRequestBehavior = JsonRequestBehavior.AllowGet, MaxJsonLength = Int32.MaxValue };
            }
            catch (Exception ex)
